...
-(void)xywSetImgUrlStr:(NSString *)imgUrl withID:(NSInteger)itmID placeImg:(UIImage *)placeImg
{
    self.tag = itmID;
    SDWebImageManager *manager = [SDWebImageManager sharedManager];
    UIImage *diskImg = [[SDImageCache sharedImageCache] imageFromDiskCacheForKey:imgUrl];
    if (diskImg) {
        self.image = diskImg;
        return;
    }
...
-(UIImage *)xywImgUrlStr:(NSString *)imgUrl
{
    SDWebImageManager *manager = [SDWebImageManager sharedManager];
    UIImage *diskImg = [[SDImageCache sharedImageCache] imageFromDiskCacheForKey:imgUrl];
    if (diskImg) {
...
-(void)xywSetVideoImgUrlStr:(NSString *)imgUrl withID:(NSInteger)itmID placeImg:(UIImage *)placeImg
{
    self.tag = itmID;
    SDWebImageManager *manager = [SDWebImageManager sharedManager];
    UIImage *diskImg = [[SDImageCache sharedImageCache] imageFromDiskCacheForKey:imgUrl];
