...
NSString *const MJRefreshHeaderIdleText = @"往下，再往下";
NSString *const MJRefreshHeaderPullingText = @" 好啦好啦，可以松手啦~";
...
NSString *const MJRefreshAutoFooterNoMoreDataText = @"别拉啦，全都给你啦~";
...
NSString *const MJRefreshBackFooterNoMoreDataText = @"别拉啦，全都给你啦~";