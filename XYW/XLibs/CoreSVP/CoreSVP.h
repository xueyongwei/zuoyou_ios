...
#define CoreSVPBottomMsg(msg) [CoreSVP showSVPWithType:CoreSVPTypeBottomMsg Msg:msg duration:2 allowEdit:YES beginBlock:nil completeBlock:nil];
#define CoreSVPCenterMsg(msg) [CoreSVP showSVPWithType:CoreSVPTypeCenterMsg Msg:msg duration:1 allowEdit:YES beginBlock:nil completeBlock:nil];
#define CoreSVPCenterMsgShort(msg) [CoreSVP showSVPWithType:CoreSVPTypeCenterMsg Msg:msg duration:0.5 allowEdit:YES beginBlock:nil completeBlock:nil];
#define CoreSVPCenter3sMsg(msg) [CoreSVP showSVPWithType:CoreSVPTypeCenterMsg Msg:msg duration:3 allowEdit:YES beginBlock:nil completeBlock:nil];
#define CoreSVPCenter2sMsg(msg) [CoreSVP showSVPWithType:CoreSVPTypeCenterMsg Msg:msg duration:2 allowEdit:YES beginBlock:nil completeBlock:nil];
typedef enum {
