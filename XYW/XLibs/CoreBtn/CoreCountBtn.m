...
-(void)statusNormal{
    ...
    //启用
    self.enabled = YES;
    self.layer.borderColor = [UIColor colorWithHexColorString:@"ff4a4b"].CGColor;
    [self setTitleColor:[UIColor colorWithHexColorString:@"ff4a4b"] forState:UIControlStateNormal];
    [self.countLabel removeFromSuperview];
}

-(void)unUse{
    self.enabled = NO;
    self.layer.borderColor = [UIColor colorWithHexColorString:@"c1c1c1"].CGColor;
    [self setTitleColor:[UIColor colorWithHexColorString:@"c1c1c1"] forState:UIControlStateNormal];
    [self.countLabel removeFromSuperview];
}
...
-(void)counting{
    ...
    self.countLabel.text = [NSString stringWithFormat:@"重发 (%@s)",@(_countNum--)];
