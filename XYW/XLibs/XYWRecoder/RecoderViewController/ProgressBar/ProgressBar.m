...
- (void)initalize
{
    ...
    _barView.backgroundColor = [UIColor colorWithHexColorString:@"7f7f7f"];
    [self addSubview:_barView];
    
    //最短分割线
    CGFloat intervalViewX = DEVICE_SIZE.width*(MIN_VIDEO_DUR/MAX_VIDEO_DUR);
    UIView *intervalView = [[UIView alloc] initWithFrame:CGRectMake(intervalViewX, 0, 1, BAR_H)];
...
//    _progressIndicator.contentMode = UIViewContentModeScaleAspectFill;
...
- (UIView *)getProgressView
{
    ...
    progressView.backgroundColor = [UIColor colorWithHexColorString:@"ff4a4b"];
...
- (void)setLastProgressToStyle:(ProgressBarProgressStyle)style
{
    ...
    switch (style) {
        ...
        {
            lastProgressView.backgroundColor = [UIColor colorWithHexColorString:@"ff4a4b" alpha:0.5];
            _progressIndicator.hidden = YES;
        }
            break;
        case ProgressBarProgressStyleNormal:
        {
            lastProgressView.backgroundColor = [UIColor colorWithHexColorString:@"ff4a4b"];
