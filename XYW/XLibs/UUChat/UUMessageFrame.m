...
- (void)setMessage:(UUMessage *)message{
    ...
    if (_showTime){
        ...
        CGSize timeSize = [_message.zyFormatTime sizeWithFont:ChatTimeFont constrainedToSize:CGSizeMake(300, 100) lineBreakMode:NSLineBreakByWordWrapping];
    ...
    switch (_message.type) {
        case UUMessageTypeText:
            contentSize = [_message.strContent sizeWithFont:ChatContentFont  constrainedToSize:CGSizeMake(screenW - 4*ChatIconWH , CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
