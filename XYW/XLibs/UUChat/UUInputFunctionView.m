...
- (id)initWithSuperVC:(UIViewController *)superVC
{
    ...
    if (self) {
        self.backgroundColor = [UIColor colorWithHexColorString:@"f5f5f6"];
...
//        [self addSubview:self.btnVoiceRecord];
        ...
        self.TextViewInput = [[UITextView alloc]initWithFrame:CGRectMake(7.5, 8.5, Main_Screen_Width-72.5, 33)];
        ...
        //输入框的提示语
        placeHold = [[UILabel alloc]initWithFrame:CGRectMake(20, 0, 200, 33)];
        placeHold.text = @"";
//        placeHold.text = @"输入消息内容";
        ...
        btn.frame = CGRectMake(Main_Screen_Width-57, 8.5, 50, 33);
        [btn setTitle:@"发送" forState:UIControlStateNormal];
        [btn setBackgroundColor:[UIColor colorWithHexColorString:@"ff4a4b"]];
