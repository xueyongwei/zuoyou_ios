...
#import "UHCareTbaleView.h"

@implementation UHCareTbaleView
...
-(void)prepareDataWithPg:(NSInteger)page
{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@/social/followlist",HeadUrl];
...
-(void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    thisCell.iconImgV.tag = model.mid;
    DbLog(@"display id %ld",model.mid);
...
//    [self setNameLabel:thisCell.userNameLabel headImageV:thisCell.iconImgV with:model.mid];
    ...
    if (model.mid == my.mid.integerValue) {
...
//    NSDictionary *user = [usf objectForKey:KUSERINFO];
//    if (model.mid == [NSString stringWithFormat:@"%@",[user objectForKey:kUSERID]].integerValue) {
